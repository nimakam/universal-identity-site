...
[![Other pages - Roadmap][pages-roadmap-tile]][pages-roadmap-tile-click]
[![Other pages - About us][pages-about-us-tile]][pages-about-us-tile-click]

[pages-roadmap-tile]: assets/images/main/pages-roadmap-tile.png
[pages-roadmap-tile-click]: roadmap
[pages-about-us-tile]: assets/images/main/pages-about-us-tile.png
[pages-about-us-tile-click]: about-us

## Problem

The biggest part of the so called "identity problem" is hidden in plain sight. The most significant issue with the current state-of-the-art by far is the enormous macro-economic costs forced onto the collective in terms of usage, integration, and maintenance of a fragmented collection of identity systems. Other portions of the identity problem are mostly due to limitations of existing technology around security, privacy and centralization, that need to be mitigated by a future solution. There are also problems that come from the new set of decentralized identity technologies, namely with recoverability and usability.
